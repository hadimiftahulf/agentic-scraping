...
| SCR-BE-04 | Backend  | Done   | Implement image processing pipeline (download -> resize -> watermark) | 3 Jam    | [jakartanotebook-sourcing.md] |
| SCR-BE-05 | Backend  | Done   | Integrate with Prisma for database upserts | 2 Jam    | [jakartanotebook-sourcing.md] |
