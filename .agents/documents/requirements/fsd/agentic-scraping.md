...
## 1. System Overview
The system is a collection of services designed to automate the process of sourcing products from Jakartanotebook and listing them on Facebook Marketplace. It consists of a Scraper (Python), Backend API (Node.js), Worker (Node.js/Playwright), and a Dashboard (Next.js).
